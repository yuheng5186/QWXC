...
- (void) createHeaderView {
    ...
    userName.textColor                  = [UIColor colorWithHexString:@"#3a3a3a"];
    ...
    seeNumberLabel.textColor                  = [UIColor colorWithHexString:@"#868686"];
    ...
    sayTimeLab.textColor                = [UIColor colorWithHexString:@"#999999"];
    ...
    backgroudView.backgroundColor       = [UIColor colorWithHexString:@"#f6f6f6"];
    ...
    textTitleLabel.textColor                = [UIColor colorWithHexString:@"#4a4a4a"];
    ...
    textContentLabel.textColor                = [UIColor colorWithHexString:@"#999999"];
    ...
    goodNumberLabel.textColor                = [UIColor colorWithHexString:@"#999999"];
    ...
    downView.frame = CGRectMake(0, QWScreenheight -QWScreenheight*100/667, QWScreenWidth, QWScreenheight*60/667);
    downView.backgroundColor  = [UIColor whiteColor];
    
    
    self.userSayTextField                = [[UITextField alloc]initWithFrame:CGRectMake(0, 0, QWScreenWidth-150, QWScreenheight*40/667)];
    ...
    self.userSayTextField.layer.borderColor     = [UIColor colorWithHexString:@"#b4b4b4"].CGColor;
    self.userSayTextField.left           = QWScreenWidth*10/375 ;
    self.userSayTextField.top            = QWScreenheight*10/667;
    ...
    sayShowLabel.textColor                  = [UIColor colorWithHexString:@"#999999"];
    ...
    goodShowLabel.textColor                  = [UIColor colorWithHexString:@"#999999"];
