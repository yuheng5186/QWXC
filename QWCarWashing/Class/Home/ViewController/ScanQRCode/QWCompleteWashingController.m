...
@interface QWCompleteWashingController ()

@end

@implementation QWCompleteWashingController
...
- (void) createSubView {
    ...
    UIView *middleView                  = [UIUtil drawLineInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height*60/667) color:[UIColor whiteColor]];
