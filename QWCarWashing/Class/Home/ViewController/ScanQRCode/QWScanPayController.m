...
static NSString *id_paySelectCell = @"id_paySelectCell";@implementation QWScanPayController
...
- (void)setupUI {
    ...
    bottomPayButton.backgroundColor = [UIColor colorFromHex:@"#ffce36"];
