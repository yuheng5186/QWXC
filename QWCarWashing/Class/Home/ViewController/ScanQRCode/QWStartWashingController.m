...
@interface QWStartWashingController ()<UIScrollViewDelegate>
{
...
- (void) backButtonClick:(id)sender {
    ...
    if (self.endstr<0) {
        ...
        if ([arrController[0] isKindOfClass:[QWScanController class]]||[arrController[1] isKindOfClass:[QWInputCodeController class]]) {
            self.tabBarController.selectedIndex = 0;
        }else{
            // 返回到倒数第三个控制器
            
            if([lastVC isKindOfClass:[QWHomeViewController class]]||[arrController[1] isKindOfClass:[QWInputCodeController class]]) {
            ...
            else
            {
                ...
                QWHomeViewController *earnVC = [[QWHomeViewController alloc]init];
