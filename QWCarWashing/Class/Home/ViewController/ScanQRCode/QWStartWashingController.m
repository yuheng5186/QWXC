...
#import "QWCompleteWashingController.h"

@interface QWStartWashingController ()

@end

@implementation QWStartWashingController
...
- (void) createSubView {
    ...
    UIView *titleView                  = [UIUtil drawLineInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height*80/667) color:[UIColor whiteColor]];
    titleView.top                      = 74;
    ...
    UIView *downView                  = [UIUtil drawLineInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height*60/667) color:[UIColor whiteColor]];
...
//    UIButton    *adButton       = [UIUtil drawButtonInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height*100/667) iconName:@"guanggao33" target:self action:@selector(adButtonClick:)];
    ...
    [adButton addTarget:self action:@selector(adButtonClick:) forControlEvents:UIControlEventTouchUpInside];
        ...
        adButton.bottom        = self.view.height -Main_Screen_Height*80/667+64;
    if (Main_Screen_Height == 568) {
        adButton.bottom        = self.view.height -Main_Screen_Height*85/667+64;
    }
    if (Main_Screen_Height == 667) {
        adButton.bottom        = self.view.height -Main_Screen_Height*75/667+64;
    }
    if (Main_Screen_Height == 736) {
        adButton.bottom        = self.view.height -Main_Screen_Height*70/667+64;
    }
    ...
    [self.view addSubview:adPageButton];
}

- (void) adButtonClick:(id)sender {
    
    QWCompleteWashingController     *completeVC     = [[QWCompleteWashingController alloc]init];
