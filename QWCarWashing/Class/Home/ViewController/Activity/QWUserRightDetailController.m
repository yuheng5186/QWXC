...
@interface QWUserRightDetailController ()

@end

@implementation QWUserRightDetailController
...
- (void) createSubView {
    ...
    UIView *downView                = [UIUtil drawLineInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height*200/667) color:[UIColor whiteColor]];
