...
- (void) craeteSubView {
    ...
    UILabel *contentNameLabel           = [UIUtil drawLabelInView:self.view frame:CGRectMake(0, 0, Main_Screen_Width-20, Main_Screen_Height*200/667) font:contentNameFont text:contentName isCenter:NO];
