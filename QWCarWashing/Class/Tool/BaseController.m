...
- (UIView *)statusView
{
    if (!_statusView) {
        ...
        _statusView.backgroundColor = [UIColor colorWithHexString:@"#293754"];
...
{
    UIColor *color = [UIColor colorWithHexString:@"0xffffff"];//[UIColor colorWithRed:99/255.0 green:99/255.0 blue:99/255.0 alpha:1];
